    ...
    <main className="app">
      <header className="hero">
        ...
        <div>
          ...
          <p className="lede">
            Fresh Vite + TypeScript scaffold ready for building the browsing history explorer. Start
            by wiring the data loaders, then iterate on the bubble heatmap and treemap overlays.
          </p>
        </div>
      </header>
